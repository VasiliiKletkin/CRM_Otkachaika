...
class ReportAdmin(SuperUserAdminMixin, admin.ModelAdmin):
    ...
    def change_view(self, request, object_id, extra_context=None):
        self.fields = ('company', 'date_start', 'date_end', 'profit',
                       'count_orders', 'count_new_addresses', 'count_new_clients')
        self.readonly_fields = ('company', 'date_start', 'date_end', 'profit',
                                'count_orders', 'count_new_addresses', 'count_new_clients')
