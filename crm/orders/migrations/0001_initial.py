    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_completed', model_utils.fields.MonitorField(blank=True, default=None, monitor='status', null=True, verbose_name='Дата выполнения', when={'COMPLETED'})),
                ('is_sent', models.BooleanField(default=False, verbose_name='Отправлен водителю')),
                ('address', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='orders', to='clients.address', verbose_name='Адрес')),
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='orders', to='companies.company', verbose_name='Компания')),
                ('dispatcher', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='created_orders', to=settings.AUTH_USER_MODEL, verbose_name='Диспетчер')),
