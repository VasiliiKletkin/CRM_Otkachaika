...
class Report(models.Model):
    ...
    # def __str__(self):
    #     return f'{self.id}, Date: {self.date.strftime("%m/%Y")}'

    # @property
    # def orders(self):
    #     return Order.objects.filter(company=self.company,
    #                                 date_created__year=self.date.year,
    #                                 date_created__month=self.date.month)

    # @property
    # def drivers(self):
    #     return Driver.objects.filter(profile__company=self.company,
    #                                  orders__date_created__year=self.date.year,
    #                                  orders__date_created__month=self.date.month
    ...
    #     self.count_new_addresses = Address.objects.filter(company=self.company, date_created__year=self.date.year,
    #                                                       date_created__month=self.date.month).count()
    #     self.save()